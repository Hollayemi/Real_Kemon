...
.menu-active li a:hover{
  color:rgb(247, 231, 201) !important;
}
...
$row = mysqli_fetch_assoc($run);
  ...
  <style>
    #header.header-scrolled,
    #header.header-fixed, #footer, #footer .footer-top, .section-header::before{
    ...
    #intro .play-btn {
      background: radial-gradient(".$row['MainColor']." 50%, rgba(101, 111, 150, 0.15) 52%);
    }
    #intro .about-btn {
      border:2px solid ".$row['LinkColor'].";
    }

    #intro .about-btn:hover{
      background:".$row['LinkColor'].";
    }
    #intro h1 span {
      color:".$row['LinkColor'].";
    }
    #footer .footer-top h4{
      border-bottom-color:".$row['LinkColor'].";
    }
    .mafa{
    ...
    .btn{
      background:".$row['MainColor'].";
      border:1px solid ".$row['MainColor'].";
      color:".$row['LinkColor'].";
      transition:.3s;
    }
    .btn:hover{
      background:".$row['SubColor'].";
      border:1px solid ".$row['SubColor'].";
    }

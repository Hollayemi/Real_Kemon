...
$sql="SELECT phone,shop_name,bustop,junction,whatsapp,facebook,linked_in,our_offer,city,bgPic,latitude,longitude FROM marketers WHERE id='$user_id'";

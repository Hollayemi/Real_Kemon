...
<h2>Hi <?php echo $_SESSION['shop_name'];?>, You are about to make 1 year subscription with token of <?php echo $_SESSION['year1']?></h2><br>
    ...
    var handler = PaystackPop.setup({
      ...
      callback: function(response){
           const referenced = response.reference;
		       window.location.href='gathering_important _data_for_the_user.php?Registration_Fee_Successfullypaid='+ referenced+<?php echo "'__".$_SESSION['name'].'-'.$_SESSION['reffered']."'"?>;
